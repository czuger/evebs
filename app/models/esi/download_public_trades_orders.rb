  ...
  def download
    ...
    Region.all.each do |region|
      ...
      orders_data.each do |order_data|
        ...
        orders << { duration: order_data['duration'], is_buy_order: order_data['is_buy_order'], issued: order_data['issued'],
    ...
    File.open('data/public_trades_orders.yaml', 'w') {|f| f.write orders.to_yaml }

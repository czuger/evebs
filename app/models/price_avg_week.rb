    ...
    orders.each do |o|
      ...
      if sorted_orders.count > 1
        ...
        until sorted_orders.empty?
          ...
          sales_dailies << SalesDaily.new( day: highest_order.day,
                                           trade_hub_id: trade_hub_conversion_hash[highest_order.cpp_system_id],
                                           eve_item_id: eve_item_conversion_hash[highest_order.cpp_type_id],

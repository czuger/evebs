...
def test_inserts_full_hierarchy(app):
    with app.app_context():
        ...
        station = UniverseStation.query.filter_by(id=60003760).first()
...
def test_system_with_no_stations(app):
    ...
    with app.app_context():
        ...
        assert UniverseSystem.query.filter_by(id=30000142).first() is not None
        assert UniverseStation.query.count() == 0

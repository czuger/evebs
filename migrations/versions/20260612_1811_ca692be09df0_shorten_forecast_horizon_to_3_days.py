"""shorten forecast horizon to 3 days

Revision ID: ca692be09df0
Revises: 1ecb2458e196
Create Date: 2026-06-12 18:11:30.664047
...
revision: str = 'ca692be09df0'
down_revision: Union[str, None] = '1ecb2458e196'
branch_labels: Union[str, Sequence[str], None] = None
depends_on: Union[str, Sequence[str], None] = None


# Identical to revision 1ecb2458e196 but the forecast horizon is the next 3 days instead of
# 7. Two training windows per item over Jita sales_finals (last 7 days and last 30 days);
# `y` is the volume-weighted daily price for the price MV, daily total volume for the volume
# MV. Per-window slope/intercept/r2/n + confidence; `spread`/`spread_percent` compare the
# 30-day vs 7-day forecast per date.

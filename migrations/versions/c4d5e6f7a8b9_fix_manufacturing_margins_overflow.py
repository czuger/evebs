"""Fix integer overflow in jita_manufacturing_margins: cast to bigint
...
WITH mat_costs AS (
    SELECT
        ...
        b.prod_qtt,
        SUM(bm.required_qtt::bigint * 100 * jp.min_sell_price) AS manufacturing_cost
    FROM blueprints b
...
SELECT
    ...
    mc.prod_qtt::bigint * 100 * jp_prod.max_buy_price                AS estimated_selling_price,
    mc.prod_qtt::bigint * 100 * jp_prod.max_buy_price * 0.05         AS selling_tax,
    (mc.prod_qtt::bigint * 100 * jp_prod.max_buy_price)
        - (mc.prod_qtt::bigint * 100 * jp_prod.max_buy_price * 0.05)
        - mc.manufacturing_cost

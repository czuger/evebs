...
class CopyList(db.Model):
    __tablename__ = 'copy_lists'
    ...
    user = db.relationship('User', back_populates='copy_lists')
    universe_system = db.relationship('UniverseSystem', back_populates='copy_lists')

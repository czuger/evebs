...
class WeeklyPriceDetail(db.Model):
    ...
    __table_args__ = (
        db.UniqueConstraint('eve_item_id', 'universe_system_id', 'day', name='uq_weekly_price_details_item_hub_day'),
    )
    ...
    universe_system = db.relationship('UniverseSystem', back_populates='weekly_price_details')

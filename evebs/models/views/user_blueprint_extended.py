...
class UserBlueprintExtended(db.Model):
    ...
    Columns:
      ...
      is_invented_from_id     – blueprints.id of the T1 blueprint this was invented from (NULL for T1)
      invented_from_name      – blueprints.name of that T1 blueprint (NULL for T1)
      invented_from_item_slug – eve_items.slug of the T1 produced item (NULL for T1)
    """
    ...
    is_invented_from_id     = db.Column(db.Integer)
    invented_from_name      = db.Column(db.String)
    invented_from_item_slug = db.Column(db.String)

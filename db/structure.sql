...
--
-- Name: blueprint_components components_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--
...
CREATE INDEX index_characters_on_character_pl_share_id ON public.characters USING btree (character_pl_share_id);
...
CREATE INDEX index_characters_on_download_my_assets ON public.characters USING btree (download_my_assets);
...
ALTER TABLE ONLY public.characters
    ADD CONSTRAINT fk_rails_8aa1b2b31d FOREIGN KEY (character_pl_share_id) REFERENCES public.characters(id);

...
ActiveRecord::Schema.define(version: 2020_01_05_150016) do
  ...
  create_table "constants", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["libe"], name: "index_constants_on_libe", unique: true
  end
  ...
  create_table "eve_items", id: :serial, force: :cascade do |t|
    ...
    t.float "volume"
    t.integer "production_level", limit: 2
    ...
    t.index ["slug"], name: "index_eve_items_on_slug", unique: true
  end
  ...
  create_table "universe_regions", force: :cascade do |t|
    ...
    t.integer "download_process_id", limit: 2, default: 1
  ...
  create_table "users", id: :serial, force: :cascade do |t|
    ...
    t.integer "min_amount_for_advice", default: 5000000, null: false
    t.boolean "admin", default: false, null: false
    t.boolean "batch_cap", default: true, null: false
    t.integer "vol_month_pcent", default: 5, null: false
    ...
    t.integer "batch_cap_multiplier", default: 10, null: false
